package com.licker2689.lpc.api.inventory;
...
public class LInventory extends CraftInventoryCustom {
    ...
    public LInventory(InventoryHolder holder, String title, int size, JavaPlugin plugin) {
    ...
    public LInventory(InventoryHolder holder, String title, int size, boolean usePage, JavaPlugin plugin) {
        super(holder, size, title);
