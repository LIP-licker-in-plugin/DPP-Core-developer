...
public class LPHApplyEvent extends Event implements Cancellable {
    @NotNull
    ...
    public LPHApplyEvent(@NotNull CommandSender requester, @NotNull String key, @NotNull Object value, @NotNull String result, boolean isWithColor, boolean isGlobalValue) {
