package com.licker2689.lpc.api.logger;
...
public class LLogger {
    ...
    public LLogger(JavaPlugin plugin) {
        this.plugin = plugin;
    ...
    public LLogger(JavaPlugin plugin, boolean useConsoleLog) {
        this.plugin = plugin;
    ...
    public LLogger(JavaPlugin plugin, boolean useConsoleLog, byte logLevel) {
        this.plugin = plugin;
        this.useConsoleLog = useConsoleLog;
