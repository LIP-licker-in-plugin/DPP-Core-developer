...
public class LPlaceHolder {
    ...
    public LPlaceHolder(CommandSender requester, String key, Object value) {
        this.requester = requester;
        this.key = key;
        this.value = value;
    }

    public LPlaceHolder(CommandSender requester, String key, Object value, boolean isGlobalValue) {
        this.requester = requester;
        this.key = key;
        this.value = value;
    ...
    public LPlaceHolder(CommandSender requester, String key, Object value, long interval) {
        this.requester = requester;
        this.key = key;
        this.value = value;
        this.useTask = true;
    ...
    public LPlaceHolder(CommandSender requester, String key, Object value, long interval, boolean isGlobalValue) {
        this.requester = requester;
        this.key = key;
        this.value = value;
        this.useTask = true;
    ...
    public String apply(String s) {
        ...
        Bukkit.getPluginManager().callEvent(new LPHApplyEvent(requester, key, value, r, false, isGlobalValue));
        return r;
    }

    public String applyWithColor(String s) {
        String r = ChatColor.translateAlternateColorCodes('&', s.replace("{" + key + "}", value.toString()));
        Bukkit.getPluginManager().callEvent(new LPHApplyEvent(requester, key, value, r, true, isGlobalValue));
        return r;
    }
    ...
    public String applyAsPlayer(String s, Player p) {
        if(value instanceof Map) {
            ...
            if(map.containsKey(p.getUniqueId())) {
                ...
                Bukkit.getPluginManager().callEvent(new LPHApplyEvent(p, key, value, r, false, isGlobalValue));
                return r;
            }
        }
        return s;
    ...
    public String applyAsPlayerWithColor(String s, Player p) {
        if(value instanceof Map) {
            ...
            if(map.containsKey(p.getUniqueId())) {
                ...
                Bukkit.getPluginManager().callEvent(new LPHApplyEvent(p, key, value, r, true, isGlobalValue));
                return r;
            }
        }
        return s;
